...
namespace constants {
    ...
    inline const std::array<CameraInfo, num_cams> Cameras = {{
        {/*912.f, 912.f, 700.f, 500.f,*/ 900.f, 900.f, 655.f, 595.f, (Eigen::Matrix4f() << 0,-1,0, 0.f, //972.339f, 972.207f, 712.366f, 538.83f,
                                                                          0,0,-1,  0.f,
                                                                          1,0,0, 0.f,
                                                                          0,0,0,  1).finished()},
        {/*915.f, 915.f,*/ 900.f, 900.f, 627.5f, 550.f, (Eigen::Matrix4f() << 0,-1,0, 0.f, //971.697f, 970.822f, 660.752f, 519.795f,
                                                                          0,0,-1,  0.f,
                                                                          1,0,0, 0.f,
                                                                          0,0,0,  1).finished()}
    }};
